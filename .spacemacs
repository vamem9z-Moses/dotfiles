...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   ;; Either nil or number of seconds. If non-nil zone out after the specified
...
default it calls `spacemacs/load-spacemacs-env' while loads the environment
...
you should place your code here."
  ;; activate column indicator in text-mode and prog-mode
